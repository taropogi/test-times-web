...
<div id="containerdash">
	...
	<form action="adminhome.do" onsubmit="return validate(this);" method="post">
		<input type="hidden" name="action" value="adminUpdateHome"/>
		<input type="hidden" name="id" value='<c:out value='${singlehome.id}'/>'/>
	
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="projfiles" >
		<tr>
			<th colspan="2">Edit Home Page</th>
		</tr>
						...
						<td class="itemthumb">
							...
							<table border="0" cellspacing="01" cellpadding="01" width="100%">
								<tr>
									...
									<td>
										<input type="text" id="title*" name="title*" value="${singlehome.title}" class="item"/>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" name="subtitle" value="${singlehome.subtitle}" class="item"/>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<span class="item">${singlehome.company.name}</span>
									</td>
								</tr>
								<tr valign="top">
									<td>
									...
									<td colspan="3">
									<FCK:editor instanceName="body_FCK" width="95%" height="350px" value="${singlehome.body}" basePath="/FCKeditor" toolbarSet="Basic"/>
									</td>
								</tr>
								<tr>
