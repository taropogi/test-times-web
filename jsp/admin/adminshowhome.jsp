...
<c:set var="pagemessage" value="Modify the Home page of all Generic companies." />
...
<div id="containerdash">
	<div id="messagearea">
	<form method="post" action="adminhome.do?action=adminUpdateGenericHome">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" id="table" class="projfiles">
		...
		<tr>
			<td class="itemthumb">
				<FCK:editor instanceName="body_FCK" width="90%" height="350px" value="${home ne null ? home.body : ''}" basePath="/FCKeditor" toolbarSet="Basic"/>
			</td>
		</tr>
		<tr>
			<td align="center">
