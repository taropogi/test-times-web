...
<c:set var="reportname" value="salesByCompany"/>
		...
		<tr>
			<td align="left" valign="top">
				...
				<table id="table" border="0" cellpadding="0" cellspacing="0" width="100%" class="projfiles">
					...
					<tr>
						<th>Sales Report by Company</th>
					</tr>
					<tr>
						<td>
							<form name="form6" action="adminreportssalesbycompany.do?action=generateSalesReportByCompany" method="post">
								<table>
									<tr>
										<td>Company: </td>
										<td>
