...
<c:set var="reportname" value="salesBySONumber"/>
		...
		<tr>
			<td align="left" valign="top">
				...
				<table id="table" border="0" cellpadding="0" cellspacing="0" width="100%" class="projfiles">
					...
					<tr>
						<th>Sales for SO Number:</th>
					</tr>
					<tr class="bground" >
						<td class="itemthumb">
						
						<form name="form1" action="adminreportssalesbyso.do?action=generateSalesBySONumber" method="post">
						<table boder="0" cellspacing="0" cellpadding="3">
							<tr>
								<td>Company: </td>
							<td>
							<select name="company" id="company" onchange="populatecompany(map, this.value, this.form.department);">
								<c:forEach items="${companies}" var="company" varStatus="ctr">
