...
<c:set var="reportname" value="transaction"/>
		...
		<tr>
			<td align="left" valign="top">
				...
				<table id="table" border="0" cellpadding="0" cellspacing="0" width="100%" class="projfiles">
					...
					<tr>
						<th>Summary Per Transaction</th>
					</tr>
					<tr class="bground">
						<td class="itemthumb">
						
						<form name="form3" action="adminreportstransactions.do?action=generateTransactionSummary" method="post">
