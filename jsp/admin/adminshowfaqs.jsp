...
<c:set var="submenu" value="faqs" />
<c:set var="pagemessage" value="Modify the FAQs page of all Generic companies." />
...
<div id="containerdash">
	<div id="messagearea">
	<form method="post" action="adminaboutus.do?action=adminUpdateAboutUs">  
	<table border="0" cellpadding="0" cellspacing="0" width="100%" id="table" class="projfiles">
		<tr>
			<th colspan="2">
				<img src="images/admin/email.png" width="16" height="16" border="0"/>FAQs
			</th>
		</tr>
		<tr>
			<td class="itemthumb">
		...
		<tr>
			<td align="center">
			<input type="submit" value="Update FAQs" />  
			</td>
		</tr>
	</table>
	</form>
