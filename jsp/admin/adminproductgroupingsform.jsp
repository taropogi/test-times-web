<form id='groupingform' name="grouping" onsubmit="return false;">
<table border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td>
			<span class="formLabelText">Type<span class="requiredfield">*</span></span>
		</td>
		<td>:</td>
		<td>
			<select name="alltypes" width="250" style="width: 250px" class="listings">
	...
	<tr>
		...
		<td align="left">
			...
			<input type="button" name="submitb" class="buttonitem" value="add" onclick="addNewGrouping(this.form);" />
