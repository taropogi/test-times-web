...
FCKConfig.ToolbarSets["UploadOnly"] = [
  	['Image','Flash']
] ;
...
FCKConfig.LinkBrowserWindowWidth	= 0 ;		// 70%
FCKConfig.LinkBrowserWindowHeight	= 0 ;	// 70%
...
FCKConfig.ImageBrowserWindowWidth  = 0 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = 0 ;	// 70% ;
...
FCKConfig.FlashBrowserWindowWidth  = 0 ;	//70% ;
FCKConfig.FlashBrowserWindowHeight = 0 ;	//70% ;
...
//FCKConfig.ImageUploadAllowedExtensions	= "" ;		// empty for all
//FCKConfig.ImageUploadDeniedExtensions	= ".*$" ;							// empty for no one
